...
const PrivacySecurityScreen = () => {
  ...
  const SECURITY_SETTINGS: SecurityOption[] = [
    {
      id: "password",
  ...
  const PRIVACY_SETTINGS: SecurityOption[] = [
    {
      id: "push",
  ...
  const ACCOUNT_SETTINGS: SecurityOption[] = [
    {
      id: "activity",
      icon: "time-outline",
          ...
          {SECURITY_SETTINGS.map((setting) => (
            ...
            >
              <View className="flex-row items-center">
                <View className="bg-primary/20 rounded-full size-12 items-center justify-center mr-4">
                  <Ionicons
